...
window.hubspot.formsnext.version = "FormsNext/static-5.432/".replace(/\/(static(-\d+\.\d+)?)\//, "-$1");
		...
		return function e(t, n, i) {
			...
			3: [function(e, t, n) {
				...
				function c(e, t, n, i) {
					...
					T && (O || r !== N.compositionStart ? r === N.compositionEnd && O && (c = O.getData()) : O = g.getPooled(t));
			...
			7: [function(e, t, n) {
				...
				function o(e, t) {
					w = t, (N = e).attachEvent("onchange", r)
				}

				function s() {
					N && (N.detachEvent("onchange", r), N = null, w = null)
				}
				...
				function u(e, t) {
					N = e, w = t, O = e.value, R = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(N, "value", L), N.attachEvent("onpropertychange", d)
				}

				function p() {
					N && (delete N.value, N.detachEvent("onpropertychange", d), N = null, w = null, O = null, R = null)
				}
				...
				function h(e, t, n) {
					return e !== D.topSelectionChange && e !== D.topKeyUp && e !== D.topKeyDown || !N || N.value === O ? void 0 : (O = N.value, w)
				}
			...
			54: [function(e, t, n) {
				...
				function r() {
					w.EventEmitter.injectReactEventListener(N), w.EventPluginHub.injectEventPluginOrder(l), w.EventPluginHub.injectInstanceHandle(O), w.EventPluginHub.injectMount(R), w.EventPluginHub.injectEventPluginsByName({
						SimpleEventPlugin: A,
					...
					}), w.NativeComponent.injectGenericComponentClass(v), w.NativeComponent.injectTextComponentClass(D), w.NativeComponent.injectAutoWrapper(i), w.Class.injectMixin(f), w.NativeComponent.injectComponentClasses({
						button: b,
						form: x,
						iframe: S,
						img: y,
						...
						head: P("head"),
						body: P("body")
					}), w.DOMProperty.injectDOMPropertyConfig(p), w.DOMProperty.injectDOMPropertyConfig(j), w.EmptyComponent.injectEmptyComponent("noscript"), w.Updates.injectReconcileTransaction(M), w.Updates.injectBatchingStrategy(g), w.RootIndex.injectCreateReactRootIndex(u.canUseDOM ? s.createReactRootIndex : L.createReactRootIndex), w.Component.injectEnvironment(h), w.DOMComponent.injectIDOperations(E)
				}
				var a = e(3),
					o = e(7),
					s = e(8),
				...
				var g = e(10),
					...
					H = {
						...
						_registerComponent: function(e, t) {
							O(t && (t.nodeType === j || t.nodeType === P)), v.ensureScrollValueMonitoring();
						...
						registerContainer: function(e) {
							var t = r(e);
							return t && (t = y.getReactRootIDFromNodeID(t)), t || (t = y.createReactRootID()), B[t] = e, t
						},
						unmountComponentAtNode: function(e) {
							O(e && (e.nodeType === j || e.nodeType === P));
							var t = r(e),
								n = V[t];
							return !!n && (H.unmountComponentFromNode(n, e), delete V[t], delete B[t], !0)
						},
						unmountComponentFromNode: function(e, t) {
							for (C.unmountComponent(e), t.nodeType === P && (t = t.documentElement); t.lastChild;) t.removeChild(t.lastChild)
						},
...
! function() {
	...
	o = ["arial, helvetica, sans-serif", "'courier new', courier", "helvetica", "'times new roman', times", "verdana, geneva"];
	...
	s = function(e, t) {
		...
		for (n = 0, i = t.length; n < i; n++) {
			o = t[n];
			if (a = p.trim(o), d.call(r, a) < 0) return !1
		}
		return !0
	};
	...
	if (!(p = {
			...
			getSelectedOptionsByLabel: function(e, t) {
				...
				return (r = (a = s(o, i) ? i : n).map((l = this, function(t) {
					var n;
			...
			getSourceName: function() {
				return (/^([^\d]+)-static/.exec(p.getSource()) || [])[1]
			},
			getSourceVersion: function() {
				return (/([\d.]+$)/.exec(p.getSource()) || [])[1]
			},
			getSourceVersionMajor: function() {
				return (/^(\d)+\./.exec(p.getSourceVersion()) || [])[1]
			},
			...
			runCustomerCallbackFunction: function(e, t, n, i) {
				...
				if ("onBeforeFormInit" !== t && "onFormDefinitionFetchError" !== t && (s = e.props[t]) && "function" == typeof s) try {
					return (l = window.jQuery || window.parent.jQuery) ? s(l(a.findDOMNode(e))) : console.error("The " + t + " function in hbspt.forms.create requires jQuery. It was not run.")
				} catch (o) {
					r = o;
			...
			shouldRenderShell: function(e, t) {
				var n, i, r;
				return !e.shell && (!p.isShareableLink() && (!p.isCos(e) && (!!(null != t && null != (n = t.scopes) ? n.renderShell : void 0) || (!(null != t && null != (i = t.scopes) ? i.rawHtmlAccess : void 0) || !p.shouldRenderFormRawHtml(e, null != t ? t.formData : void 0)) && (!e.hasOwnProperty("css") && !(!(null != t && null != (r = t.formData) ? r.themeName : void 0) || t.formData.themeName === l.legacyThemeName)))))
			},
			...
			shouldApplyThemeCss: function(e, t, n) {
				return !e.hasOwnProperty("css") && (!p.shouldRenderFormRawHtml(e, t) || !(null != n ? n.rawHtmlAccess : void 0))
			},
			...
			setKeyValueObject: function(e, t) {
				...
				i = e.substring(0, n);
				s = e.substring(n + 1);
				return 0 === i.length ? p.setKeyValueObject(s, t) : 0 === s.length ? ((a = {})["" + i] = t, a) : ((o = {})["" + i] = p.setKeyValueObject(s, t), o)
			},
			parseContextTranslations: function(e) {
				...
				for (t in e) {
					i = e[t];
					p.isObject(i) ? this.extend(n, p.setKeyValueObject(t, p.parseContextTranslations(i))) : this.extend(n, p.setKeyValueObject(t, i))
				}
				return n
			}
		}).currentScript)
...
! function() {
	...
	n = i.createClass({
		...
		getInitialValues: function() {
			...
			if ("phone" === this.props.name && "CONTACT" === this.props.propertyObjectType && i)
				if (this.props.defaultValue) {
					if (s.getCountryCodeFromKnownProperties(this.props.knownProperties)) {
						...
						(n = s.getExtensionFromCountryCode(t)) && (r = r.substring(n.length))
					}
				} else {
...
! function() {
	...
	r = c.createClass({
		...
		monitorDomResize: function() {
			var e;
			return null != window.ResizeObserver ? new ResizeObserver((e = this, function(t) {
				return e.handleRendered(t[0])
			})).observe(document.getElementsByClassName("hbspt-form")[0]) : setInterval(this.handleRendered, 500)
		},
		getDefaultProps: function() {
			return {
				noBrandingScope: !0
...
! function() {
	...
	a = {
		...
		renderForm: function(i, a, u, p, d, f, m, h, g, v, b, x, y, E, S, k) {
			var C, T, I, D, _, N, w, O, R, M, F, L, A, j, P, V, B, z, U, H, q, G, K, W, Y, Q, J, Z, X, $, ee, te, ne, ie, re, ae, oe, se;
			...
			A = i.locale || hubspot.utils.getlocaleCode(null != (q = i.validationOptions) ? q.lang : void 0) || o(a) || "en";
			L = hubspot.utils.isRtl(A, i, a, f);
